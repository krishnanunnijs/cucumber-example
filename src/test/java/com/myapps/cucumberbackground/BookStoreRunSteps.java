package com.myapps.cucumberbackground;


import com.myapps.cucumberbackground.util.CucumberDataExtractor;
...
public class BookStoreRunSteps {
    ...
    public void setUp(Scenario scenario) {
        ...
        List<List<String>> rows =  CucumberDataExtractor.extractDatatableArguments(scenario);
